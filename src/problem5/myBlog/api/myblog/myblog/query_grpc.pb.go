...
const (
	Query_Params_FullMethodName   = "/myblog.myblog.Query/Params"
	Query_ShowPost_FullMethodName = "/myblog.myblog.Query/ShowPost"
	Query_ListPost_FullMethodName = "/myblog.myblog.Query/ListPost"
)
