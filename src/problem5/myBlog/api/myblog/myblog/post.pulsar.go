...
func init() {
	...
	md_Post = File_myblog_myblog_post_proto.Messages().ByName("Post")
...
func (x *Post) slowProtoReflect() protoreflect.Message {
	mi := &file_myblog_myblog_post_proto_msgTypes[0]
...
func (x *fastReflection_Post) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "myblog.myblog.Post.title":
		return x.Title != ""
	case "myblog.myblog.Post.body":
		return x.Body != ""
	case "myblog.myblog.Post.creator":
		return x.Creator != ""
	case "myblog.myblog.Post.id":
		return x.Id != uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: myblog.myblog.Post"))
		}
		panic(fmt.Errorf("message myblog.myblog.Post does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Post) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message myblog.myblog.Post does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Post) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "myblog.myblog.Post.title":
		panic(fmt.Errorf("field title of message myblog.myblog.Post is not mutable"))
	case "myblog.myblog.Post.body":
		panic(fmt.Errorf("field body of message myblog.myblog.Post is not mutable"))
	case "myblog.myblog.Post.creator":
		panic(fmt.Errorf("field creator of message myblog.myblog.Post is not mutable"))
	case "myblog.myblog.Post.id":
		panic(fmt.Errorf("field id of message myblog.myblog.Post is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: myblog.myblog.Post"))
		}
...
func (x *fastReflection_Post) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in myblog.myblog.Post", d.FullName()))
	}
	panic("unreachable")
}
...
func (*Post) Descriptor() ([]byte, []int) {
	return file_myblog_myblog_post_proto_rawDescGZIP(), []int{0}
}
...
var File_myblog_myblog_post_proto protoreflect.FileDescriptor

var file_myblog_myblog_post_proto_rawDesc = []byte{
	0x0a, 0x18, 0x6d, 0x79, 0x62, 0x6c, 0x6f, 0x67, 0x2f, 0x6d, 0x79, 0x62, 0x6c, 0x6f, 0x67, 0x2f,
	0x70, 0x6f, 0x73, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0d, 0x6d, 0x79, 0x62, 0x6c,
	0x6f, 0x67, 0x2e, 0x6d, 0x79, 0x62, 0x6c, 0x6f, 0x67, 0x22, 0x5a, 0x0a, 0x04, 0x50, 0x6f, 0x73,
	...
	,
}

var (
	file_myblog_myblog_post_proto_rawDescOnce sync.Once
	file_myblog_myblog_post_proto_rawDescData = file_myblog_myblog_post_proto_rawDesc
)

func file_myblog_myblog_post_proto_rawDescGZIP() []byte {
	file_myblog_myblog_post_proto_rawDescOnce.Do(func() {
		file_myblog_myblog_post_proto_rawDescData = protoimpl.X.CompressGZIP(file_myblog_myblog_post_proto_rawDescData)
	})
	return file_myblog_myblog_post_proto_rawDescData
}

var file_myblog_myblog_post_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_myblog_myblog_post_proto_goTypes = []interface{}{
	(*Post)(nil), // 0: myblog.myblog.Post
}
var file_myblog_myblog_post_proto_depIdxs = []int32{
...
func init() { file_myblog_myblog_post_proto_init() }
func file_myblog_myblog_post_proto_init() {
	if File_myblog_myblog_post_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_myblog_myblog_post_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Post); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_myblog_myblog_post_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_myblog_myblog_post_proto_goTypes,
		DependencyIndexes: file_myblog_myblog_post_proto_depIdxs,
		MessageInfos:      file_myblog_myblog_post_proto_msgTypes,
	}.Build()
	File_myblog_myblog_post_proto = out.File
	file_myblog_myblog_post_proto_rawDesc = nil
	file_myblog_myblog_post_proto_goTypes = nil
	file_myblog_myblog_post_proto_depIdxs = nil
}
