document.addEventListener("DOMContentLoaded", () => {
  ...
  function updateBalance() {
    ...
    fromBalance.textContent = `Wallet Balance: ${balance.toFixed(
      4
    )} ${currency}`;
    ...
    toBalance.textContent = `Wallet Balance: ${toBalanceAmount.toFixed(
      4
    )} ${toCurrencyValue}`;
  }
  ...
  function swapCurrencies() {
    const tempCurrency = fromCurrencyWrapper.querySelector(
      ".custom-select-trigger span"
    ).textContent;
    fromCurrencyWrapper.querySelector(
      ".custom-select-trigger span"
    ).textContent = toCurrencyWrapper.querySelector(
      ".custom-select-trigger span"
    ).textContent;
    toCurrencyWrapper.querySelector(".custom-select-trigger span").textContent =
      tempCurrency;
